...
```
###### DoLah\Commands\AddTaskCommand.cpp
``` cpp
#include "Command.h"
...
```
###### DoLah\Commands\ClearTaskCommand.cpp
``` cpp
#include "Command.h"
...
```
###### DoLah\Commands\DeleteTaskCommand.cpp
``` cpp
#include "Command.h"
...
```
###### DoLah\Commands\EditTaskCommand.cpp
``` cpp
#include "Command.h"
...
```
###### DoLah\Commands\RedoTaskCommand.cpp
``` cpp
#include "Command.h"
...
```
###### DoLah\Commands\SearchTaskCommand.cpp
``` cpp
#include "Command.h"
...
```
###### DoLah\Commands\SetDoneTaskCommand.cpp
``` cpp
#include "Command.h"
...
```
###### DoLah\Commands\UndoTaskCommand.cpp
``` cpp
#include "Command.h"
...
```
###### DoLah\Models\CalendarInverter.cpp
``` cpp
...
```
###### DoLah\Models\CalendarInverter.h
``` h
#pragma once
#include <Models/Calendar.h>
...
```
###### DoLah\Models\CommandHistory.cpp
``` cpp
...
```
###### DoLahTest\CalendarInverterTest.cpp
``` cpp
#include "stdafx.h"
...
```
###### DoLahTest\CalendarUnitTest.cpp
``` cpp
#include "stdafx.h"
#include "CppUnitTest.h"
...
```
###### DoLahTest\CommandHistoryTest.cpp
``` cpp
#include "stdafx.h"
#include "CppUnitTest.h"
